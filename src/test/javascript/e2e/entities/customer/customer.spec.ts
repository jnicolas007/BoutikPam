...
describe('Customer e2e test', () => {
  ...
  it('should load Customers', async () => {
    ...
    expect(await customerComponentsPage.getTitle()).to.eq('boutikPamApp.customer.home.title');
  });
  ...
  it('should load create Customer page', async () => {
    ...
    expect(await customerUpdatePage.getPageTitle()).to.eq('boutikPamApp.customer.home.createOrEditLabel');
  ...
  it('should create and save Customers', async () => {
    ...
    expect(await customerUpdatePage.getEmailInput()).to.eq('email@email.com', 'Expected Email value to be equals to email');
  ...
  it('should delete last Customer', async () => {
    ...
    expect(await customerDeleteDialog.getDialogTitle()).to.eq('boutikPamApp.customer.delete.question');
