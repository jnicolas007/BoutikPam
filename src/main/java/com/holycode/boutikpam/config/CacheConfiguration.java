package com.holycode.boutikpam.config;
...
public class CacheConfiguration implements DisposableBean {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("BoutikPam");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("BoutikPam");
        ...
        config.getMapConfigs().put("com.holycode.boutikpam.domain.*", initializeDomainMapConfig(jHipsterProperties));
